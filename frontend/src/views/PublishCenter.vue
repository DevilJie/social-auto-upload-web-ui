  ...
  for (let i = 0; i < allTasks.length; i++) {
    ...
    try {
      ...
      const publishData = {
        ...
        thumbnailLandscape: videoFormat === 'landscape' && commonConfig.coverLandscape ? commonConfig.coverLandscape.stored_path : '',
        thumbnailPortrait: videoFormat === 'portrait' && commonConfig.coverPortrait ? commonConfig.coverPortrait.stored_path : '',
